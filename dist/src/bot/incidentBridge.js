 ...
 */
export function isIncidentThread(message, client) {
 ...
 */
export function getIncidentForThread(threadId) {
 ...
 */
export async function handleIncidentMessage(message, incidentId) {
