...
const TRIAGE_PROMPT_TEMPLATE = (alert) => `You are an SRE triage assistant analyzing a new infrastructure alert. Be concise — this goes into a Discord thread.
 ...
 */
export async function triggerAutoTriage(client, sessions, threadId, alert, config = {}) {
    try {
