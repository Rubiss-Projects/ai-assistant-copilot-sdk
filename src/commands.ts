...
export const commands = [
  ...
  new SlashCommandBuilder()
    ...
    .addSubcommand((sub) =>
      sub.setName("list").setDescription("List available custom agents")
    )
    .addSubcommand((sub) =>
      sub.setName("current").setDescription("Show the currently active agent")
    )
    .addSubcommand((sub) =>
      sub
        .setName("select")
        ...
        .addStringOption((opt) =>
          opt.setName("name").setDescription("Agent name").setRequired(true)
        )
    )
    .addSubcommand((sub) =>
      sub.setName("deselect").setDescription("Return to the default agent")
    ),
  ...
  new SlashCommandBuilder()
    ...
    .addSubcommand((sub) =>
      sub.setName("get").setDescription("Show the current session mode")
    )
    .addSubcommand((sub) =>
      sub
        .setName("set")
  ...
  new SlashCommandBuilder()
    ...
    .addSubcommand((sub) =>
      sub.setName("read").setDescription("Show the current session plan")
    )
    .addSubcommand((sub) =>
      sub
        .setName("update")
        ...
        .addStringOption((opt) =>
          opt.setName("content").setDescription("New plan content").setRequired(true)
        )
    )
    .addSubcommand((sub) =>
      sub.setName("delete").setDescription("Delete the session plan")
    ),
  ...
  new SlashCommandBuilder()
    ...
    .addSubcommand((sub) =>
      sub.setName("list").setDescription("List files in the session workspace")
    )
    .addSubcommand((sub) =>
      sub
        .setName("read")
        ...
        .addStringOption((opt) =>
          opt.setName("path").setDescription("Relative file path").setRequired(true)
        )
    )
    .addSubcommand((sub) =>
      sub
        ...
        .addStringOption((opt) =>
          opt.setName("content").setDescription("File content").setRequired(true)
        )
    ),
];
